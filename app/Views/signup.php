...
<?php endif; ?>
    ...
    <div class="form-outline mb-3">
        ...
        <?php if(isset($validation['name'])) { echo "<br><p style='color:red' >$validation[name]</p>"; } ?>
    </div>

    <div class="form-outline mb-3">
        <input type="email" id="form3Example3cg" name="email" class="form-control" placeholder="Your Email" aria-label="Your Email" value='<?= set_value('email') ?>'>
        <?php if(isset($validation['email'])) { echo "<br><p style='color:red' >$validation[email]</p>"; } ?>
    </div>

    <div class="form-outline mb-3">
        <input type="phone" id="form3Example3cg" name="phone_no" class="form-control" placeholder="Your Phone" aria-label="Your Phone" value='<?= set_value('phone_no') ?>'>
        <?php if(isset($validation['phone_no'])) { echo "<br><p style='color:red' >$validation[phone_no]</p>"; } ?>
    </div>

    <div class="form-outline mb-3">
        <input type="password" id="form3Example4cg" name="password" class="form-control" placeholder="Password" aria-label="Password" value='<?= set_value('password') ?>'>
        <?php if(isset($validation['password'])) { echo "<br><p style='color:red' >$validation[password]</p>"; } ?>
    </div>
