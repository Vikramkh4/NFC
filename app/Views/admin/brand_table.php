        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <div class="right-align my-3">
                    <a href="<?= base_url(AD . 'brand?user_id='.$_GET['user_id'].'') ?>" class="btn btn-default btn-icon icon-left">
                        Add Brand
                        ...
                        <tbody>
                            <?php foreach ($brands as $key => $emp): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url(AD); ?>editbrand/<?=$emp['id']."?user_id=".$_GET['user_id']?>" class="btn btn-default btn-sm btn-icon icon-left">
