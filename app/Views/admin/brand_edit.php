...
<?php endif;?>
<form enctype="multipart/form-data" name="brand_form" action="<?=base_url(AD.'editbrand/'.$brand['id'])?>" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" type="url"value="<?=$brand['google_review']?>" name="google_review" placeholder="New York">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="url" name="enqlink"value="<?=$brand['enqlink']?>" placeholder="Form Link ">
            </div>
        </div> <div class="col-md-6">
            <div class="form-group">
