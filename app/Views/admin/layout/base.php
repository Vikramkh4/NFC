...
<head>
	...
	<link rel="stylesheet" href="<?=base_url();?>/<?=base_url();?>/assets22/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css">
	<link rel="stylesheet" href="<?=base_url();?>/<?=base_url();?>/assets22/css/font-icons/entypo/css/entypo.css">
				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<?=base_url();?>/assets2/images/thumb-1@2x.png" alt="" class="img-circle" width="44" />
							John Henderson
						</a>
							...
							<li>
								...
								<ul class="dropdown-menu-list scroller">
									<li class="active">
										<a href="#">
											<span class="image pull-right">
												<img src="<?=base_url();?>/assets2/images/thumb-1@2x.png" width="44" alt="" class="img-circle" />
											</span>
									...
									<li class="active">
										<a href="#">
											<span class="image pull-right">
												<img src="<?=base_url();?>/assets2/images/thumb-2@2x.png" width="44" alt="" class="img-circle" />
											</span>
									...
									<li>
										<a href="#">
											<span class="image pull-right">
												<img src="<?=base_url();?>/assets2/images/thumb-3@2x.png" width="44" alt="" class="img-circle" />
											</span>
									...
									<li>
										<a href="#">
											<span class="image pull-right">
												<img src="<?=base_url();?>/assets2/images/thumb-4@2x.png" width="44" alt="" class="img-circle" />
											</span>
				...
				<ul class="list-inline links-list pull-right">
					...
					<li class="dropdown language-selector">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
							<img src="<?=base_url();?>/assets2/images/flags/flag-uk.png" width="16" height="16" />
						</a>
		
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="#">
									<img src="<?=base_url();?>/assets2/images/flags/flag-de.png" width="16" height="16" />
									<span>Deutsch</span>
								</a>
							</li>
							<li class="active">
							...
							<li>
								<a href="#">
									<img src="<?=base_url();?>/assets2/images/flags/flag-fr.png" width="16" height="16" />
									<span>François</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="<?=base_url();?>/assets2/images/flags/flag-al.png" width="16" height="16" />
									<span>Shqip</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="<?=base_url();?>/assets2/images/flags/flag-es.png" width="16" height="16" />
									<span>Español</span>
								</a>
							</li>
						</ul>
