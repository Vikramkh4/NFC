...
<div class="card-header pb-0">
    <h2>Product Table</h2>
    <a href="<?= base_url(AD . 'product?brand_id=' . $_GET['brand_id']) ?>" class="btn btn-default btn-icon icon-left" style="float: right; margin-bottom: 10px;">
        Add Product 
    ...
    <tbody>
        <?php foreach ($product as $key => $emp): ?>
            <tr>
                ...
                <td><?= $emp['price'] ?></td>
                <td>
                    <a href="<?= base_url(AD . 'editproduct/' . $emp['id'] . "?brand_id=" . $_GET['brand_id']) ?>" class="btn btn-default btn-sm btn-icon icon-left">
