    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form enctype="multipart/form-data" name="brand_form" action="<?=base_url(VD.'services2')?>" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                        <input class="form-control" type="text" name="name" placeholder="Name of Service">
